...
def matrix():
    ...
    try:
        ...
        print(_here, end = '')
        liveType(msg3, 0.1167*delayFactor, 8.515*remainFactor)  # type: ignore # 0.1167 and 8.515 seconds measured from the real scene from film "The Matrix"
        clearTrm()
        ...
        clearTrm ()
        print(_here, end = '')
        liveType(exitMsg, 0.045*delayFactor, 3.5*remainFactor)# type: ignore
